...
parser.add_argument(
    '--input_video', default="../input/data-nckh-facerecognition/102180195.h264", type=str, help='Path_to_Video')
parser.add_argument("--output_folder", default="/content/image_raw/")
...
if __name__ == '__main__':
    ...
    video = cv2.VideoWriter(
        VIDEO_NAME, cv2.VideoWriter_fourcc(*'XVID'), 30, (888, 500))
    ...
    while (cap.isOpened()):
        ...
        if ret == True:
            ...
            if args.save_image:
                ...
                video.write(cv2.resize(img_raw, (888, 500)))
                count += 1
        else:
            break
